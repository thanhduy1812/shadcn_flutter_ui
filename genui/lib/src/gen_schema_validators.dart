...
class GenNotEmptyValidator extends GenValidator<String> {
  ...
  @override
  Validator<String> build() => VNLNotEmptyValidator(message: message.value);
}
...
class GenLengthValidator extends GenValidator<String> {
  ...
  Validator<String> build() =>
      VNLLengthValidator(min: min.value, max: max.value, message: message.value);
}
...
class GenRegexValidator extends GenValidator<String> {
  ...
  @override
  Validator<String> build() =>
      VNLRegexValidator(RegExp(pattern.value), message: message.value);
}
...
class GenEmailValidator extends GenValidator<String> {
  ...
  @override
  Validator<String> build() => VNLEmailValidator(message: message.value);
}
...
class GenUrlValidator extends GenValidator<String> {
  ...
  @override
  Validator<String> build() => VNLURLValidator(message: message.value);
}
