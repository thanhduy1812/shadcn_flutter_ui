...
class GenBadgeSchema extends GenSchema {
  ...
  Widget buildWidget(BuildContext context) {
    ...
    return switch (variant[context]) {
      BadgeVariant.primary => VNLPrimaryBadge(child: label),
      BadgeVariant.secondary => VNLSecondaryBadge(child: label),
      BadgeVariant.outline => VNLOutlineBadge(child: label),
      BadgeVariant.destructive => VNLDestructiveBadge(child: label),
    };
  }
}
