...
import 'package:vnl_common_ui_genui/src/gen_schema_validators.dart';
...
class GenDatePickerSchema extends GenSchema {
  ...
  Widget buildWidget(BuildContext context) {
    ...
    // VNLDatePicker delegates its actual rendering to ObjectFormField
    // internally, which is form-aware (FormValueSupplier), so no manual
    // reporting is needed here.
    final field = VNLDatePicker(
      value: date,
