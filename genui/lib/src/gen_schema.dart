...
import 'package:json_schema_builder/json_schema_builder.dart' hide VNLValidationResult;
...
extension GenActionDispatcherX on GenActionDispatcher? {
  /// For plain callbacks like `VNLButton.onPressed`.
...
extension GenValueActionDispatcherX<T> on GenValueActionDispatcher<T>? {
  /// For single-argument callbacks like `VNLTextField.onChanged`.
