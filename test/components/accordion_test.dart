...
void main() {
  group('VNLAccordion', () {
    testWidgets('renders without exceptions', (tester) async {
      await tester.pumpWidget(
        SimpleApp(
          child: VNLAccordion(
            items: [
              VNLAccordionItem(
                trigger: VNLAccordionTrigger(child: Text('Item 1')),
      ...
      expect(find.byType(VNLAccordion), findsOneWidget);
        ...
        SimpleApp(
          child: VNLAccordion(
            items: [
              ...
              VNLAccordionItem(
                trigger: VNLAccordionTrigger(child: Text('Item 2')),
    ...
    testWidgets('applies theme correctly', (tester) async {
      await tester.pumpWidget(
        SimpleApp(
          child: ComponentTheme<VNLAccordionTheme>(
