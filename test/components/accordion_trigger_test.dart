...
void main() {
  group('VNLAccordionTrigger', () {
      ...
      await tester.pumpWidget(
        VNLookApp(
          home: VNLAccordion(
            items: [
              VNLAccordionItem(
                trigger: VNLAccordionTrigger(child: const Text('Trigger Text')),
    ...
    testWidgets('shows focus indicator when focused', (tester) async {
      ...
      final trigger =
          tester.widget<VNLAccordionTrigger>(find.byType(VNLAccordionTrigger));
    ...
    testWidgets('has hover underline mechanism', (tester) async {
      ...
      final triggerFinder = find.byType(VNLAccordionTrigger);
