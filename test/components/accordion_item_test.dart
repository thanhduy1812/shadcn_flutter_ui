...
void main() {
  group('VNLAccordionItem', () {
      ...
      await tester.pumpWidget(
        VNLookApp(
          home: VNLAccordion(
            items: [
              VNLAccordionItem(
                trigger: VNLAccordionTrigger(child: const Text('Trigger')),
      ...
      await tester.pumpWidget(
        VNLookApp(
          home: VNLAccordion(
            items: [
              VNLAccordionItem(
                trigger: VNLAccordionTrigger(child: const Text('Trigger 1')),
                content: const Text('Content 1'),
              ),
              VNLAccordionItem(
                trigger: VNLAccordionTrigger(child: const Text('Trigger 2')),
    ...
    testWidgets('respects expanded parameter', (tester) async {
      ...
      final item = tester.widget<VNLAccordionItem>(find.byType(VNLAccordionItem));
    ...
    testWidgets('handles empty content gracefully', (tester) async {
      ...
      expect(find.byType(VNLAccordionItem), findsOneWidget);
    });
