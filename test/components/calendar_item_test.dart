...
void main() {
  group('VNLCalendarItem', () {
    testWidgets('renders none type', (tester) async {
      ...
      expect(find.byType(VNLCalendarItem), findsOneWidget);
      expect(find.byType(VNLGhostButton), findsOneWidget);
    ...
    testWidgets('renders today type', (tester) async {
      ...
      expect(find.byType(VNLCalendarItem), findsOneWidget);
      expect(find.byType(VNLSecondaryButton), findsOneWidget);
      expect(find.text('15'), findsOneWidget);
    });
    ...
    testWidgets('respects disabled state', (tester) async {
      ...
      final button = find.byType(VNLGhostButton);
      expect(button, findsOneWidget);

      // The button should be disabled
      final ghostButton = tester.widget<VNLGhostButton>(button);
