...
void main() {
  group('VNLBasicLayout', () {
    testWidgets('renders with no content', (tester) async {
      await tester.pumpWidget(
        SimpleApp(
          child: VNLBasicLayout(),
        ),
      );

      expect(find.byType(VNLBasicLayout), findsOneWidget);
    ...
    testWidgets('renders with reasonable size', (tester) async {
      ...
      final layoutFinder = find.byType(VNLBasicLayout);
    ...
    testWidgets('does not apply text styling like VNLBasic widget',
        (tester) async {
      // VNLBasicLayout should not apply text styling, unlike VNLBasic
      await tester.pumpWidget(
        SimpleApp(
          child: Column(
            children: [
              VNLBasic(
                title: Text('VNLBasic Title'),
                subtitle: Text('VNLBasic Subtitle'),
              ),
              VNLBasicLayout(
      ...
      expect(find.byType(VNLBasicLayout), findsOneWidget);
      expect(find.text('VNLBasic Title'), findsOneWidget);
